...
function generateNavigation(langCode) {
  ...
  const translations = {
    ...
    es: {
      ...
      'Visual HAT': 'HAT Visual',
      'Code HAT': 'HAT de Código',
      'Gen HAT': 'HAT Generativo',
      'Time Graph HAT': 'HAT de Gráfico Temporal',
    ...
    fr: {
      ...
      'Visual HAT': 'HAT Visuel',
      'Code HAT': 'HAT de Code',
      'Gen HAT': 'HAT Génératif',
      'Time Graph HAT': 'HAT Graphe Temporel',
